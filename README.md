...
Made for the Better FeedBack workshop addon. It aggressively strips silenced weapon tracer data from `CMsgTEFireBullets` while keeping the shot sound fields and leaving other effects untouched.
