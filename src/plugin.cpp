                            ...
                            unsigned long messageSize)
{
    if (IsFireBullets(networkMessage) && ShouldHideTracer(messageData, messageSize))
    {
        ...
        // Keep the FireBullets message so clients still receive shot sound and
        // normal impacts. Only neutralize the weapon identity used for the
        // client-side tracer selection/replacement path.
