...
void Log(const char *format, ...)
{
    ...
    std::ofstream file("addons/SilencedTracerBlocker/stb_debug.log", std::ios::app);
    if (file.is_open())
        file << buffer;
}
...
bool SilencedTracerBlocker::Load(PluginId id, ISmmAPI *ismm, char *error, size_t maxlen, bool late)
{
    ...
    Log("[STB] SilencedTracerBlocker loaded. impacts/blood untouched. FireEventHook=on ListenerWeaponFire=%s\n",
