                            ...
                            unsigned long messageSize)
{
    if (IsFireBullets(networkMessage) && IsSuppressedFireBullets(messageData, messageSize))
    {
        ...
        // Do not restore these fields after PostEventAbstract: on some builds the
        // engine queues/serializes the message after this hook returns, so restoring
        // immediately makes the client receive the original tracer data again.
