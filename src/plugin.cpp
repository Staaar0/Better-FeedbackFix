                            ...
                            unsigned long messageSize)
{
    if (IsFireBullets(networkMessage) && IsSuppressedFireBullets(messageData, messageSize))
    {
        ...
        // Keep the FireBullets message so CS2 still sends the normal weapon sound,
        // but make the protobuf look like a sound-only FireBullets message by
        // removing tracer-driving field presence bits and clearing their values.
