...
// Minimal CS2 network_connection.pb.h compatibility header.
//
// Current public CS2 HL2SDK headers include network_connection.pb.h for the
// ENetworkDisconnectionReason enum used by interface declarations. The SDK
// mirror used by GitHub Actions can miss the generated protobuf header. This
// plugin does not use protobuf messages, so a lightweight enum definition is
// enough to compile cleanly on both Linux and Windows without pulling protobuf
